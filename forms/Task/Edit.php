<?php
class Application_Form_Task_Edit extends Zend_Form{
     ...
     public function showOldData()
     {
             $this->setDefaults(array( 
                     'name'        =>   $this->_dataTask['name'], 
                     'link'        =>   $this->_dataTask['link'], 
                     'for'         =>   $this->_dataTask['for'], 
                     'position'    =>   $this->_dataTask['position'], 
             ));
     }
